...
from apps.appointment import appointment_bp
from apps.web import web_bp
from apps.user import user_bp
from apps.equipment import equipment_bp
from apps.sign import sign_bp
from apps.collect import collect_bp
